...
public class OrderServiceImplTests {
    ...
    public void testPlaceOrder() {
        ...
        oi1.setProduct(newProduct("Pizza", "pizza dough, tomato sauce, cheese, pepperoni", Money.valueOf(Currency.MKD,1500)));
        oi1.setQuantity(1);

        OrderItemForm oi2 = new OrderItemForm();
        oi2.setProduct(newProduct("Spaghetti bolognese", "spaghetti, bolognese sauce", Money.valueOf(Currency.MKD,500)));
        oi2.setQuantity(2);
        ...
        Order newOrder = orderService.findById(newOrderId).orElseThrow(() -> new OrderIdDoesNotExistException());
